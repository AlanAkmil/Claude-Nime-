          ...
          <footer className="mt-20 relative w-full bg-gradient-to-t from-[#090b0e] to-transparent py-14">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
              ...
              <div className="text-[#a9b7c6] space-y-4 text-[15px] leading-relaxed mx-auto max-w-4xl">
                <p>
                  <span className="text-[#ff4e00]">claudenime.vercel.app</span> is top of free streaming website, where to watch anime online free without registration required. 
                  With a big database and great features, we're confident. claudenime.vercel.app is the best free anime online website in the space that you can't simply miss!
                </p>
                <p>
                  This site does not store any files on our server, we only linked to the media which is hosted on 3rd party services.<br/>
                  Powered by Alan. All Rights Reserved
                </p>
                <p className="mt-4 text-sm font-semibold" style={{
                  background: 'linear-gradient(to right, #ff4e00, #ffbd00)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent'
                }}>
